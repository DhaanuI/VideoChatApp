...
const urlParams = new URLSearchParams(window.location.search)  // to get room name and username from form
...
const myPeer = new Peer();  // to establish peer to peer
